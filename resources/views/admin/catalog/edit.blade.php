...
@foreach($dataCatalog as $catalog)
  ...
  <div class="form-group">
   <input type="hidden" name="_token" value="{{ csrf_token() }}">
    ...
    <div class="col-sm-10">
      <input type="text" name="name" class="form-control" id="name" value="{{$catalog->name}}" placeholder="Tên Catalog">
    </div>
  </div>
  <div class="form-group">
   <input type="hidden" name="_token" value="{{ csrf_token() }}">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="detail" class="form-control" id="detail" value="{{$catalog->detail}}" placeholder="Detail ">
